...
resource "aws_subnet" "Prod-pub-sub1" {
  ...
  tags = {
    Name = "${var.environment}-Prod-pub-sub1"
  }
}
...
resource "aws_subnet" "Prod-pub-sub2" {
  ...
  tags = {
    Name = "${var.environment}-Prod-pub-sub2"
  }
}
...
resource "aws_subnet" "Prod-priv-sub1" {
  ...
  tags = {
    Name = "${var.environment}-Prod-priv-sub1"
  }
}
...
resource "aws_subnet" "Prod-priv-sub2" {
  ...
  tags = {
    Name = "${var.environment}-Prod-priv-sub2"
  }
}
...
resource "aws_route_table" "Prod-pub-route-table" {
  ...
  tags = {
    Name = "${var.environment}-Prod-pub-route-table"
  }
}
...
resource "aws_route_table" "Prod-priv-route-table" {
  ...
  tags = {
    Name = "${var.environment}-Prod-priv-route-table"
  }
}
...
resource "aws_nat_gateway" "Prod-Nat-gateway" {
  ...
  tags = {
    Name = "${var.environment}-Prod-Nat-gateway"
  }
}
